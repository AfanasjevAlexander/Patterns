trait TemplateMethod {
    ...
    fn base_operation1(&self) {
        println!("TemplateMethod says: I'm going the bulk of the work");
    }
    ...
    fn base_operation3(&self) {
        println!("TemplateMethod says: But I am going the bulk of the work anyway");
    }
...
impl TemplateMethod for ConcreteStruct1 {
    ...
    fn required_operations2(&self) {
        println!("ConcreteStruct1 says: Omplemented Operation2")
    }
}
...
fn main() {
    println!("Same client code can to work with different concrete implementations:");
