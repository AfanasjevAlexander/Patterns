...
class AbstractClass(ABC):
    ...
    def base_operation1(self) -> None:
        print("AbstractClass says: I'm doing the bulk of the work") 

    def base_operation2(self) -> None:
        print("AbstractClass says: But I let subclasses override some operations")

    def base_operation3(self) -> None:
        print("AbstractClass says: But I'm doing the bulk of the work anyway")
    ...
    # предоставляют дополнительные точки расширения в некторых критических
    # местах алгоритма
    def hook1(self) -> None:
        pass
...
class ConcreteClass1(AbstractClass):
    """
        Конкретные классы должны реализовывать все абстрактные операции базового
