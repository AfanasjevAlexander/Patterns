...
class Component(ABC):
    ...
    """
        ...
        Таким образом, не нужно будет предоставлять конкретные классы компонентов клиентскому коду,
        даже во время сборки дерева объектов. Недостаток такого подхода в том, что эти методы 
        будут пустыми для компонента уровня листа.
    """
    ...
    def is_composite(self) -> bool:
        """
            Можно реализовать метод, который позволит клиентскому коду понять 
...
class Leaf(Component):
    """
        ...
        Обычно объекты Листьев выполняют фактическую работу, когда объекты Контейнера делегируют работу 
...
class Composite(Component):
    """
        ...
        Обычно объекты Контейнеры делегируют фактическую работусвоим детям,
    ...
    """
        Объект Контейнера может как добавлять компоненты в список вложенных компонентов,
        так и удалять их, как простые, так и сложные.
    """
    ...
    def operation(self) -> str:
        """
            ...
            рекурсивно через всех своих потомков, собирая и суммирую их результаты.
