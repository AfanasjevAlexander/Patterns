...
class ConcreteComponentA(Component):
    """
        Каждый Конкретный Компонент должен реализовывать метод accept таким образом,
...
"""
    ...
    сложной структурой объектов, такое как дерево Компоновщика. В этом случае было
