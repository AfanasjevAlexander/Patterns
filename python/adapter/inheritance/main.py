class Target:
    """
        Целевой класс объявляет интрефейс, с которым может работать клиентский код
    """
...
class Adaptee:
    """
        ...
        Адаптируемый класс нуждается в некоторой доработке, прежде чем
        клиентский код сможет его использовать
    """
